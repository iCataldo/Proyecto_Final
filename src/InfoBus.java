    ...
    public InfoBus(Tiempo tiempo){
        ...
        if (tiempo!=null) {
            this.setText("<html>Importante Leer: El vieaje tiene un tiempo estimado de " + tiempo.getTiempo() +" minutos." +
                    ...
                    "mientras que los buses doble saldran: 12:00am, 2:00pm, 6:00pm, 9:00pm, 11:00pm. <html>" +
                    "ademas el tiempo esttimados de los bus doble es " + (tiempo.getTiempo() + 11) + " minutos.");
        }
